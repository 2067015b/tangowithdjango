...
from rango.models import Page, UserProfile, Category, User
...
def index(request):
    ...
    category_list = Category.objects.order_by('-the_likes')[:5]
...
def about(request):
    context_dict = {'boldmessage': "Monika Blstakova, 2067015B"}
...
def register_profile(request):
    ...
    return render(request, 'rango/add_profile.html', context_dict)
